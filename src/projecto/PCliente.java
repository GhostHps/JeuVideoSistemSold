...
public class PCliente extends javax.swing.JFrame {
    ...
    private void BGardarActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void BActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BActualizarActionPerformed
        ...
        arre=(Cliente[]) cli.Update(arre, id, nom, ap, am, tel, email, ni, ne, calle, cp, rfc, name_user, pass_user, type_user, status);
    ...
    private void BEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEliminarActionPerformed
        Cliente cli = new Cliente();
        name_user=tnomusu.getText();
        arre= (Cliente[]) cli.delete(arre, name_user, posicion);
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        Cliente cli = new Cliente();
        name_user=tnomusu.getText();
        cli.Search(arre, name_user);

        if(cli!=null){
            cli=(Cliente) cli.Search(arre, name_user);
        }
        ...
        ne=cli.getNe();
        cp=cli.getCp();
        name_user=cli.getName_user();
        pass_user=cli.getPass_user();
